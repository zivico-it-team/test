...
const Lead = sequelize.define(
  "Lead",
  {
    ...
    followUpSetAt: { type: DataTypes.DATE, allowNull: true },
    followUpHandled: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    followUpHandledAt: { type: DataTypes.DATE, allowNull: true },
    followUpHandledById: { type: DataTypes.STRING(64), allowNull: false, defaultValue: "" },
